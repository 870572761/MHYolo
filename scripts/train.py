...
# 设置默认值
parser.set_defaults(cfg='yolov8s.yaml',
...
if __name__ == '__main__':
    # 训练模型
    results = model.train(data=args.data, epochs=args.epochs, batch=args.batch, task=args.task, optimizer=args.optimizer, device=args.device, freeze=args.freeze)
    #模型验证
    model.val()
